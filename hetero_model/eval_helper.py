...
def eval_deep(log, loader, hetero = False):
    """
    ...
    if hetero == False:
        ...
        data_size = len(loader.dataloader.dataset.indices)
    ...
    return accuracy/data_size, f1_macro/data_size, f1_micro/data_size, precision/data_size, recall/data_size, ap
