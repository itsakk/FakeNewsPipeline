...
def save_to_json_file(json_response, news_source, label, filename, tweet_id):
    if len(json_response) !=0:
        if not os.path.exists(load_path + news_source + '//' + label + '//' + filename + '//' + 'user_timeline_tweets'):
            os.mkdir(load_path + news_source + '//' + label + '//' + filename + '//' + 'user_timeline_tweets')
        with open(load_path + news_source + '//' + label + '//' + filename + '//' + 'user_timeline_tweets' + '//' + tweet_id, 'w') as outfile:
